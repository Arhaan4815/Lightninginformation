...
def dashboard():
    if ('user' in session and session['user'] == params['username_for_dashboard']):
    ...
    if request.method =='POST':
        ...
        if (username==params['username_for_dashboard'] and userpassword==params['password_for_dashboard']):
...
def contact():
    if(request.method=='POST'):
        ...
        db.session.commit()
        # mail.send_message(sender = {params['gmail-user']},
        #                   recipients = {params['gmail2-user']},
        #                   body = message
                                 # + "\n" + phone
                          # )
